...
nlq_train_data = "/feng_yi_sen/data/ego4d/official/v2/annotations/nlq_train.json"
moment_train_data = "/feng_yi_sen/data/ego4d/official/v2/annotations/moments_train.json"
vq_train_data = "/feng_yi_sen/data/ego4d/official/v2/annotations/vq_train.json"

metadata = pd.read_csv('/feng_yi_sen/data/ego4d/egoclip/egoclip.csv', sep='\t', error_bad_lines=False)

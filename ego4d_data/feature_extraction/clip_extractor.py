"""
Modified from https://github.com/jayleicn/moment_detr/blob/main/run_on_video/data_utils.py
"""
    ...
    def encode_text(self, text_list, bsz=60):
        ...
        for i in range(n_batch):
            ...
            for j, valid_len in enumerate(valid_lengths):
                text_eot_features.append(output["pooler_output"][j])
                text_features.append(batch_last_hidden_states[j, 1:valid_len-1])
        return text_features, text_eot_features  # List([L_j, d]) torch tensor
